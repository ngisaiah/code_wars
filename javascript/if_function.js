...
In statically-typed languages, the first argument will be a boolean. In dynamically-typed languages that attribute a truth value to all expressions, it may be of any type.v
*/

function _if(bool, func1, func2) {
  // Function calls func1 if bool == true
  if (bool == true){
      func1()
    } else {
      func2()
